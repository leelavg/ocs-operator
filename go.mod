...
replace github.com/red-hat-storage/ocs-operator/services/provider/pb/v4 => ./services/provider/pb

// used in tests
replace github.com/red-hat-storage/ocs-operator/services/provider/client/v4 => ./services/provider/client
...
require (
	...
	github.com/red-hat-storage/ocs-operator/services/provider/client/v4 v4.0.0-00010101000000-000000000000
